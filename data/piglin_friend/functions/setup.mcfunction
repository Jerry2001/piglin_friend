...
execute unless entity @e[tag=Jim] as @e[tag=leader, limit=1] at @s run summon minecraft:piglin ~ ~ ~ {Team: "happy", IsImmuneToZombification: 1b, Team: "happy", Tags:[Jim], PersistenceRequired: 1b, Invulnerable:1b, CustomName:"\"Jimmy\"", Attributes:[{Base:0d, Name:"generic.attack_damage"}]}

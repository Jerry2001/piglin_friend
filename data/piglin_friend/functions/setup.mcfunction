...
execute if score piglinSan piglin_friend matches 1 unless entity @e[tag=Jim] as @e[tag=leader, limit=1] at @s run summon minecraft:piglin ~ ~ ~ {IsImmuneToZombification: 1b, Tags:[Jim], PersistenceRequired: 1b, CustomName:"\"Jimmy\"", Attributes:[{Base:0d, Name:"generic.attack_damage"}], ArmorDropChances:[0f, 0f, 0f, 0f], ArmorItems: [{}, {}, {}, {id: "minecraft:player_head",Count: 1b,tag: {SkullOwner: {Id: [I; 2060941217, 1483885932, -1178037704, 1507102007],Properties: {textures: [{Value: ""}]}}}}], HandItems: [{id: "minecraft:poppy", Count: 1b}, {}], Inventory: [{id: "minecraft:minecraft:beetroot_soup", Count: 1}, {id: "minecraft:beetroot_soup", Count: 1}, {id: "minecraft:golden_hoe", Count: 1}, {id: "minecraft:saddle", Count: 1}, {id: "minecraft:rabbit_stew", Count: 1}, {id: "minecraft:mushroom_stew", Count: 1}, {id: "minecraft:rabbit_stew", Count: 1}, {id: "minecraft:suspicious_stew", Count: 1}]}
execute if score piglinSan piglin_friend matches 0 unless entity @e[tag=Jim] as @e[tag=leader, limit=1] at @s run summon minecraft:piglin ~ ~ ~ {IsImmuneToZombification: 1b, Tags:[Jim], PersistenceRequired: 1b, CustomName:"\"Jimmy\"", Attributes:[{Base:0d, Name:"generic.attack_damage"}], HandItems: [{id: "minecraft:poppy", Count: 1b}, {}], ArmorDropChances:[0f, 0f, 0f, 0f],Inventory: [{id: "minecraft:minecraft:beetroot_soup", Count: 1}, {id: "minecraft:beetroot_soup", Count: 1}, {id: "minecraft:golden_hoe", Count: 1}, {id: "minecraft:saddle", Count: 1}, {id: "minecraft:rabbit_stew", Count: 1}, {id: "minecraft:mushroom_stew", Count: 1}, {id: "minecraft:rabbit_stew", Count: 1}, {id: "minecraft:suspicious_stew", Count: 1}]}
data modify entity @e[tag= Jim, limit=1] ArmorItems set from entity @e[tag= leader, limit=1] ArmorItems
...
function piglin_friend:copyarmor
...
execute unless entity @e[tag=Jim] as @p at @s run summon minecraft:piglin ~ ~ ~ {Team: "happy", IsImmuneToZombification: 1b, Team: "happy", Tags:[Jim], PersistenceRequired: 1b, Invulnerable:1b, CustomName:"\"Jimmy\""}

...
execute if score canGiveItem piglin_friend matches 1 as @e[tag= Jim, limit=1] at @s if entity @e[type=minecraft:player, distance=0..3] run scoreboard players set canGiveItem piglin_friend 2